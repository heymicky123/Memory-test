(function () {
  ...
  d1.style.cssText = "font-family:Georgia,serif;font-size:13px;letter-spacing:0.05em;color:#4A4A46;text-decoration:none;cursor:pointer;";
  var d2 = document.createElement("span");
  d2.textContent = "Demo 2";
  d2.style.cssText = "font-family:Georgia,serif;font-size:13px;letter-spacing:0.05em;color:#BFB3A4;";
  ...
  function patch() {
    ...
    rightCol.style.cssText = "display:flex;justify-content:flex-end;align-items:center;";
